          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <div className='hidden md:ml-6 md:block'>
              <div className='flex space-x-2'>
                ...
                >
                <FaCube className='inline mr-1 mb-1'/>  Packages
                </Link>
                {session && (
                  <Link
                    href='/packages/add'
                  ...
                  >
                  <FaPlus className='inline mr-1 mb-1'/>  Add Package
                  </Link>
                )}
              </div>
            </div>
      ...
      {isMobileMenuOpen && (
        <div id='mobile-menu'>
          <div className='space-y-1 px-2 pb-3 pt-2'>
            ...
            >
              <FaCube className='inline mb-1 mr-1' /> Packages
            </Link>
            {session && (
              <Link
                href='/packages/add'
              ...
              >
              <FaPlus className='inline mb-1 mr-1'/>  Add Package
              </Link>
            )}
